...
struct Node *End(struct Node *head, char data)                      //function to insert nodes at the end of the list 
...
struct Node *Middle(struct Node *head, char data, char index)               //function to insert nodes anywhere in between the beginning and the end 
...
{ 
    ...
    { 
        ...
        cout << " Photo slide List is empty!" << endl; 
    ...
    { 
        ...
        cout << "Wrong input, slide insertion not possible!" << endl; 
...
{ 
    ...
    { 
        ...
        cout << "Wrong Photo data given, deletion not possible!" << endl; 
...
{ 
    ...
    cout << " 1. Add at the beginning photo number\n 2. Add at the end photo number \n 3. Add at index photo number \n 4. Display photo number list \n 5. Remove from the start the relevant photo \n 6. Remove from the end the relevant photo number \n 7. Remove from index \n 8. Quit" << endl; 
